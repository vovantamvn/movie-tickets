...
<head>
    <title>Free Theater Website Template | 404-page :: w3layouts</title>
            ...
            <div class="wrap">
                ...
                <div class="nav-wrap">
                    <ul class="group" id="example-one">
                        ...
                        <li><a href="index.jsp">Movies & Events</a></li>
            ...
            <div class="footer-top">
                ...
                <div class="col_1_of_4 span_1_of_4">
                    <div class="textcontact">
                        <p>consectetuer adipiscing elit,<br> consectetuer
                            <br> Ph: +1-800-234-52589.<br> Email : <a href="mailto:example@mail.com">mail@example.com</a><br>
                        </p>
                    </div>
                </div>
                <div class="col_1_of_4 span_1_of_4">
